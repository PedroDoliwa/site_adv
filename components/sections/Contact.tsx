...
import { Clock, Mail, MessageCircle, Phone, Shield } from "lucide-react";
...
const messageConsulta = encodeURIComponent("Olá, gostaria de agendar uma consulta.");
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <ContactCard
            ...
            buttonAction={() => window.location.href = "rossanahertzog@gmail.com"}
          />
          ...
          <ContactCard
            ...
            buttonAction={() => window.open(`https://wa.me/${phone}?text=${messageConsulta}`, "_blank")}
          />
        </div>
